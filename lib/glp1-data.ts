...
export const METHODS_COMPARISON: MethodRow[] = [
  {
    ...
    typicalCost: "₹2.2L - ₹4.1L/yr",
    expectedLoss: "5-12%",
    monitoring: "None",
    downside: "High dropout, muscle loss, fake-stock risk",
  },
  {
    method: "Crash Diets",
    typicalCost: "₹10K - ₹45K",
    expectedLoss: "3-8% (temporary)",
    monitoring: "None",
    downside: "Nearly always rebounds — often worse",
  },
  {
    method: "Generic Online Plans",
    typicalCost: "₹25K - ₹80K/yr",
    expectedLoss: "4-10%",
    monitoring: "App-based only",
    downside: "Generic templates, no medical personalization",
  },
  {
    method: "Bariatric Surgery",
    typicalCost: "₹2.8L - ₹6.5L",
    expectedLoss: "20-35%",
    monitoring: "High (surgical)",
    downside: "Surgical risk, recovery time, irreversible",
  },
  {
    method: "WeightWonder Plus™",
    typicalCost: "Personalised pricing",
    expectedLoss: "10-25kg in 45-90 days",
    monitoring: "Daily mentor + weekly specialist",
    downside: "Requires commitment to program engagement",
    highlighted: true,
  },
  {
    method: "WW Plus™ + GLP-1 Layer ✨",
    typicalCost: "WW program + medication",
    expectedLoss: "15-25%+ sustained",
    monitoring: "Full specialist oversight",
    downside: "GLP-1 medication cost added on top",
    highlighted: true,
  },
];
